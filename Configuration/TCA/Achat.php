	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_papmarketplace_domain_model_achat',
				'foreign_table_where' => 'AND tx_papmarketplace_domain_model_achat.pid=###CURRENT_PID### AND tx_papmarketplace_domain_model_achat.sys_language_uid IN (-1,0)',
			),
		),
		...
		'paye' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:pap_marketplace/Resources/Private/Language/locallang_db.xlf:tx_papmarketplace_domain_model_achat.paye',
			'config' => array(
				'type' => 'check',
				'default' => 0
			),
		...
		'contenus' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:pap_marketplace/Resources/Private/Language/locallang_db.xlf:tx_papmarketplace_domain_model_achat.contenus',
			'config' => array(
				'type' => 'select',
				'foreign_table' => 'tx_papmarketplace_domain_model_contenu',
				'MM' => 'tx_papmarketplace_achat_contenu_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_papmarketplace_domain_model_contenu',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
