...
/**
 * Test case for class \TYPO3\PapMarketplace\Domain\Model\Utilisateur.
 *
 * @version $Id$
 ...
 */
class UtilisateurTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new \TYPO3\PapMarketplace\Domain\Model\Utilisateur();
	}
	...
	public function setOrganisationForStringSetsOrganisation() { 
		$this->fixture->setOrganisation('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getOrganisation()
		);
	}
	...
	public function setPresentationForStringSetsPresentation() { 
		$this->fixture->setPresentation('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getPresentation()
		);
	}
	 ...
	 * @test
	 */
	public function getPaypalReturnsInitialValueForString() { }

	/**
	 * @test
	 */
	public function setPaypalForStringSetsPaypal() { 
		$this->fixture->setPaypal('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getPaypal()
		);
	}
